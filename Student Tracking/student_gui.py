...
def load_gui(self):
    ...
    self.lbl_current.grid(row=8,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    ...
    self.btn_submit = tk.Button(self.master,width=12,height=2,text='submit',command=lambda: student_func.addToList(self))
    self.btn_submit.grid(row=8,column=4,columnspan=1,padx=(15,0),pady=(45,10),sticky=E)
